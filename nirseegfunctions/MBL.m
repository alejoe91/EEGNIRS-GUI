...
%E = [e at 830-HbO e at 830-HbR e at 830-Lipide at 830-H2O e at 830-AA;
%     e at 690-HbO e at 690-HbR e at 690-Lipide at 690-H2O e at 690-AA];

E=E(1:2,1:2);   %Only keep HbO/HbR parts

dOD_w1_L = dOD_w1 * ppf/(dpf*L);        %Pre-divide by pathlength (dpf,pvcetc)
dOD_w2_L = dOD_w2 * ppf/(dpf*L);

dOD_L = [dOD_w1_L dOD_w2_L];            %Concatinate the 2(or more)wavelengths
