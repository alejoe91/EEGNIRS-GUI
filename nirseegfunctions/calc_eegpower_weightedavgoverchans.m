function eegpower = calc_eegpower_weightedavgoverchans( chanstoinclude, flag_userelativeeegpower, ...
...
for ifreqband = 1:numfreqbands,
    ...
    % weighted avg over chans
    eegdatabucket = eegdatabucket * diag(weights);
